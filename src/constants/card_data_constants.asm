...
DEF TYPE_ENERGY EQU const_value
	...
	const TYPE_TRAINER_STADIUM         ; $12
DEF NUM_CARD_TYPES EQU const_value - 2
...
DEF ABILITY_F     EQU 2
DEF ABILITY       EQU 1 << ABILITY_F
DEF DAMAGE_NORMAL EQU $00
DEF DAMAGE_PLUS   EQU $01
DEF DAMAGE_MINUS  EQU $02
DEF DAMAGE_X      EQU $03
DEF POKE_POWER    EQU ABILITY
DEF POKE_BODY     EQU ABILITY + 1
...
DEF SWITCH_OPPONENT_POKEMON_F  EQU 0
DEF HEAL_USER_F                EQU 1
DEF NULLIFY_OR_WEAKEN_ATTACK_F EQU 2
DEF DISCARD_ENERGY_F           EQU 3
DEF ATTACHED_ENERGY_BOOST_F    EQU 4
DEF FLAG_2_BIT_5_F             EQU 5
DEF FLAG_2_BIT_6_F             EQU 6
DEF FLAG_2_BIT_7_F             EQU 7
