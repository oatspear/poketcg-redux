...
; OATS FIXME should be 10, but WRAM0 goes 2 bytes beyond limits
; assume that FILTER_ENERGY will not be used
...
; wAnimationsDisabled constants
DEF ANIMATIONS_DISABLED_F EQU 1
DEF DEBUG_HUMAN_VS_HUMAN_F EQU %10
DEF DEBUG_AI_VS_AI_F EQU %100
DEF DEBUG_DUEL_CONTROLLER_MASK EQU (DEBUG_AI_VS_AI_F | DEBUG_HUMAN_VS_HUMAN_F)
