...
DEF BURN_IS_DAMAGE_OVER_TIME EQU 0

DEF SLEEP_WITH_COIN_FLIP EQU 0
DEF CLEAR_CONFUSION_ON_SWITCH EQU 0
...
DEF SUBSTATUS2_UNUSED_3           EQU $01
...
DEF USED_LIGHTNING_HASTE_THIS_TURN_F EQU 2
DEF PLAYED_SUPPORTER_THIS_TURN_F     EQU 4
DEF PLAYED_ITEM_THIS_TURN_F          EQU 5
DEF PLAYED_STADIUM_THIS_TURN_F       EQU 6
...
DEF USED_LIGHTNING_HASTE_THIS_TURN EQU 1 << USED_LIGHTNING_HASTE_THIS_TURN_F
...
DEF NO_DAMAGE_OR_EFFECT_TRANSPARENCY EQU $03
