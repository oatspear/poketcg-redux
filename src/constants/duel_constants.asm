...
DEF WEAKNESS_IS_CAPPED   EQU 0
DEF RESISTANCE_IS_CAPPED EQU 0


DEF RAIN_DANCE_AS_OFTEN_AS_YOU_LIKE EQU 1
DEF RAIN_DANCE_ATTACHES_TO_ACTIVE   EQU 1
...
; DUELVARS_ARENA_CARD_SUBSTATUS3 constants
DEF SUBSTATUS3_THIS_TURN_DOUBLE_DAMAGE_F EQU 0
DEF SUBSTATUS3_HEADACHE_F                EQU 1
DEF SUBSTATUS3_THIS_TURN_ACTIVE_F        EQU 2
DEF SUBSTATUS3_THIS_TURN_CANNOT_ATTACK_F EQU 3
DEF SUBSTATUS3_THIS_TURN_ROOTED_F        EQU 4
DEF SUBSTATUS3_POKE_POWERS_DISABLED_F    EQU 5
...
DEF SUBSTATUS3_THIS_TURN_ACTIVE        EQU 1 << SUBSTATUS3_THIS_TURN_ACTIVE_F
DEF SUBSTATUS3_THIS_TURN_CANNOT_ATTACK EQU 1 << SUBSTATUS3_THIS_TURN_CANNOT_ATTACK_F
DEF SUBSTATUS3_THIS_TURN_ROOTED        EQU 1 << SUBSTATUS3_THIS_TURN_ROOTED_F
DEF SUBSTATUS3_POKE_POWERS_DISABLED    EQU 1 << SUBSTATUS3_POKE_POWERS_DISABLED_F
...
DEF RETREATED_THIS_TURN_F            EQU 5
